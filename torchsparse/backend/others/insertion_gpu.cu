...
at::Tensor insertion_forward(const at::Tensor inputs, const at::Tensor idx,
...
at::Tensor insertion_backward(const at::Tensor top_grad, const at::Tensor idx,
                              const at::Tensor counts, const int N) {
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(
      top_grad.type(), "insertion_backward", ([&] {
